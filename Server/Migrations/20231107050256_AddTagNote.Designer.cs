            ...
            modelBuilder.Entity("Server.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("d408d909-58b1-45cd-abdb-156622776fcc"),
                            CreatedAt = new DateTime(2023, 11, 7, 5, 2, 56, 225, DateTimeKind.Utc).AddTicks(2154),
                            Login = "admin",
                            Password = "password",
                            Role = 1000,
                            UpdatedAt = new DateTime(2023, 11, 7, 5, 2, 56, 225, DateTimeKind.Utc).AddTicks(2157),
                            UserName = "admin"
                        });
                });
