...
namespace Server.Migrations
{
    ...
    [Migration("20231024195602_Initial")]
            ...
            modelBuilder.Entity("Server.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("d7af2b14-37cb-42f2-9031-fb27956e76c6"),
                            CreatedAt = new DateTime(2023, 10, 24, 19, 56, 2, 414, DateTimeKind.Utc).AddTicks(7766),
                            Login = "admin",
                            Password = "password",
                            Role = 1000,
                            UpdatedAt = new DateTime(2023, 10, 24, 19, 56, 2, 414, DateTimeKind.Utc).AddTicks(7772),
                            UserName = "Admin"
                        });
                });
